...
_AS7341_ENABLE: int = const(0x80)  # Main enable register. Controls SMUX, Flicker Detection,Spectral and
# Power
...
_AS7341_STATUS: int = const(0x93)  # Interrupt status registers. Indicates the occourance of an interrupt
_AS7341_ASTATUS: int = const(0x94)  # Spectral Saturation and Gain status. Reading from here latches the data
...
_AS7341_FD_STATUS: int = const(0xDB)  # Flicker detection status; measurement valid, saturation, flicker
